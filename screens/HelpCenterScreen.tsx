    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.content}>
          ...
          Here's where you can find answers to the most common questions we get
          from users. If you can't find the answer you're looking for, feel free
          to contact us via the button at the bottom.
          ...
          {"\n"}→ Browse available listings, click on a product, and hit "Place
          Bid".
