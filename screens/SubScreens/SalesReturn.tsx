...
interface SaleReturnEntry {
  ...
  originalSalePaymentMethod: string;
  vehicleNumber: string;
  driverName: string;
  driverContact: string;
  originalSaleFare: string;
...
export default function SalesReturnEntryReportScreen() {
  const [entries, setEntries] = useState<SaleReturnEntry[]>([]);
  ...
  const transformApiData = (data: any[]): SaleReturnEntry[] => {
  ...
  const handleRowPress = (item: SaleReturnEntry) => {
