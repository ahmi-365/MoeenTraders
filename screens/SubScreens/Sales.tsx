      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          <ScrollView showsVerticalScrollIndicator={false}>
            <Text style={styles.modalTitle}>Sales Details (Inv: {entry.invoiceNo})</Text>
  ...
  const transformApiData = (data: any[]): SalesEntry[] => {
    return data.map((item: any) => {
      ...
      return {
        ...
        receivedAmountBank: formatCurrency(actionableData.received_amount_bank, '0.00'),
        receivedAmountCash: formatCurrency(actionableData.received_amount_cash, '0.00'),
        ...
        <View style={styles.tableWrapper}>
          <ReusableTable<SalesEntry>
            ...
            emptyStateConfig={{
              ...
              emptyMessage: 'There are no sales entry records to display for the selected criteria.',
              emptyIcon: '📋'
            }}
